				...
				<div class="col-sm-6 col-md-3">
					...
					<img src="<c:url value="/img/${product.productId}.png"></c:url>" alt="image"  style = "width:100%"/>
						<div class="caption">
							...
							<p>${product.unitsInStock} <spring:message code="addProduct.form.unitsInStock.label" /></p>
							<p>
								<a href=" <spring:url value="/market/product?id=${product.productId}" /> "	class="btn btn-primary"> 
                                    <span class="glyphicon-info-sign glyphicon" ></span> <spring:message code="details.label" />
								</a>
							</p>
